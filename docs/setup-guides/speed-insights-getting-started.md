---
id: speed-insights-getting-started
...
After a few days of visitors, you'll be able to start exploring your metrics. For more information on how to use Speed Insights, see the [Vercel documentation](https://vercel.com/docs/speed-insights).
